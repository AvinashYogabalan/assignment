...
public class SalesfocusDeleted {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(600);
		driver.findElement(By.xpath("//input[@name='Account-search-input']")).sendKeys("Avinash Yogabalan",Keys.ENTER);
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[text()='Avinash Yogabalan']")).click();
